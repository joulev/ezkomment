...
- `/users/:uid`: The route to get, update and delete user information, given their uid
- `/sites/:domain`: The route to get, create, update and delete sites, given their domain URL
