...
export async function getStaticProps() {
  const image = await getOgImage({ title: "Orbital 2022 Milestone 1 README", label: "orbital" });
  return { props: { image } };
}
...
export default function ({ image, children }) {
  return (
    <BlogLayout
      ...
      seo={{
        title: "Orbital 2022 Milesotone 1 README | ezkomment",
        description:
          "The first version of the README, describing all information we have about the project.",
        image,
        url: "https://ezkomment.joulev.dev/orbital/ms1-readme",
      }}
    >
      {children}
    </BlogLayout>
