import { UploadSiteIconUtil, UploadUserPhotoUtil } from "~/old/server/utils/crud/imageUtils";
import { updateSiteWithUid } from "~/old/server/utils/crud/siteUtils";
import { updateUserById } from "~/old/server/utils/crud/userUtils";
...
} from "~/old/types/server/nextApi.type";
