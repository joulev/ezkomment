...
import { filePaths, getFileData, navData } from "~/old/client/lib/documentation";
import getOgImage from "~/old/client/lib/getOgImage";

import DocsBottomBar from "~/old/client/components/docs/bottombar";
import DocsSidebar from "~/old/client/components/docs/sidebar";
import Seo from "~/old/client/components/seo";

import { SeoProps } from "~/old/types/client/components.type";
import { DocsData, NavData } from "~/old/types/client/docs.type";
