...
export default function AppNewPage() {
  ...
  return (
    <>
      <Navbar type="overview" activeTab="new" />
        ...
        <div className="mx-auto md:max-w-lg">
          ...
          <form className="flex flex-col gap-6" onSubmit={e => e.preventDefault()}>
            <InputDetachedLabel
              ...
              helpText={
                <>
                  ...
                  contain lowercase letters, digits and hyphens. It must start with a letter and be
            ...
            <InputDetachedLabel
              ...
              helpText={
                <>
                  The hostname of the website where you want to host the comments. It can be any
                  domain or subdomain with a valid protocol or a wildcard (<code>*</code>) to match
                  all domains. Other websites will not be allowed to host the comments.{" "}
